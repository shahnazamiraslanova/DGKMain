...
import {AnnouncementIcon, DocsIcon, HomeIcon, LegisIcon, PollIcon} from 'assets/images/icons/left-menu';
...
const LeftMenuComponent = memo(({isOpen}: { isOpen: boolean }) => {
    ...
    const items = [
        ...
        {
            id: 5,
            name: translate('legislation_title'),
            link: Routes.legislation,
            icon: <LegisIcon/>,
        }
    ];
